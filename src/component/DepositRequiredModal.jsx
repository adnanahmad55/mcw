...
const DepositRequiredModal = ({ isOpen, onClose, message }) => {
        ...
        <div className="p-6">
          ...
          <div className="flex flex-row gap-3">
            <button
              ...
              className="w-full bg-gradient-to-r from-blue-500 to-blue-600 text-white py-3 rounded-lg font-medium hover:opacity-90 transition"
            >
              টাকা জমা
            </button>
          </div>
