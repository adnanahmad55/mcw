...
export default function Treasure1({ onClose }) {
  ...
  }, 0) + referralRewardsData.reduce((sum, item) => {
    return item?.reward_status === "claimed" ? sum + (item?.reward_amt || 0) : sum;
  }, 0);
              ...
              <div className="condition-count-wrap">
                ...
                <div className="progress-wrap">
                  ...
                  <div className="current-info">
                    <div className="wysiwyg">
                      Only <label>৳ {(totalAmount - totalClaimedAmount).toFixed(2)}</label> away from claim to wallet
                    </div>
                  </div>
                </div>
