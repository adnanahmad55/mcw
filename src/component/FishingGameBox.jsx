...
const categories = [
    ...
    {
        title:"FC",
        img:"https://images.6492394993.com//TCG_PROD_IMAGES/RNG_LIST_VENDOR/FC-COLOR.png",
        data:fcData,
        platform: "FC",
        gameType: "FH"
    },
    {
        title:"SPADE",
        img:"https://images.6492394993.com//TCG_PROD_IMAGES/RNG_LIST_VENDOR/SG-COLOR.png",
        data:spadeData,
        platform: "SPADE",
        gameType: "FH"
    },
    ...
    {
        title:"FS",
        img:"https://images.6492394993.com//TCG_PROD_IMAGES/RNG_LIST_VENDOR/FS-COLOR.png",
        data:fsData,
        platform: "FASTSPIN",
        gameType: "FH"
    },
        ...
        <div>
            <div className=" px-3 mb-3 overflow-hidden">
                ...
                {!isGameList ? (
                                                    ...
                                                    <div className="game-slide-group vendor-grid" style={{
                                                        ...
                                                        {categories.map((category, index) => (
                                                            <div key={category.title} onClick={() => {
                                                                navigate('/game-list?category=Fishing');
                    ...
                    <>
                        <div className='mb-4'>
                            <p className='text-white flex h-[24px] my-2 tracking-wider'> <span className='h-full w-1 mr-2 rounded-md bg-fillColor'></span> Fishing Games</p>
                        </div>
                        {/* Tabs */}
