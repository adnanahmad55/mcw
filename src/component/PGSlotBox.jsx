...
const categories = [
    {
        title:"PG",
        img:"https://images.6492394993.com//TCG_PROD_IMAGES/RNG_LIST_VENDOR/PG-COLOR.png",
        data:pgData,
        platform: "PG",
        gameType: "SLOT"
    }
        ...
        <div>
            ...
            <div className="bg-boxColor rounded-xl mb-3 overflow-hidden">
                ...
                <div className="flex title-bg justify-between items-center text-white mb-4 pl-[20px] h-[43.9467px] md:h-[68px] rounded pr-[20px] md:pr-[58px]">
                    ...
                    <button
                        className="rounded-3xl min-w-[100px] h-8 text-sm"
                ...
                {/* Tabs */}
                <div className="px-2 mb-4" style={{position:'sticky', top:0, zIndex:9, background:"#090F1F", padding:'10px'}}>
                        ...
                        {categories.map((category, index) => (
                            <button
                                ...
                                className={`flex flex-col items-center gap-2 px-2 py-1 rounded-lg whitespace-nowrap transition-all duration-200 ${
                                    activeTab === index
                                        ? 'border-b-2 border-blue-500 text-white shadow-lg'
                                        : 'border-b-2 border-gray-500 text-gray-300 hover:bg-gray-600'
                                }`}
                                style={{background:'radial-gradient(50% 60.61% at 50% 50%, #174593 0, #0f3157 100%)'}}
                            >
                                <img 
