...
const modalVariants = {
  ...
  exit: {
    ...
    return (
        <motion.div
          className="fixed inset-0 z-50 bg-[#1f1f1f] overflow-y-auto"
                                ...
                                <div className='w-full'>
                                        ...
                                        <div className='w-full bg-[#2b2922] rounded-[1.3333333333vw] p-[2.1333333333vw]'>
                                            ...
                                            <div className='w-full flex relative mt-3'>
                                                <input
                                                    ...
                                                    className='bg-[#3b392f] pl-4 text-[#fff] rounded-[1.3333333333vw] h-[11.7333333333vw] text-[4.2666666667vw] w-full'
                                    ...
                                    {showAddCardModal && (
                                        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                                            <div className="bg-[#2b2922] rounded-[1.3333333333vw] p-[2.1333333333vw] w-full max-w-md">
                                                ...
                                                <div className="space-y-4">
                                                    <div>
                                                        ...
                                                        <input
                                                            ...
                                                            className="w-full bg-[#3b392f] text-white rounded-[1.3333333333vw] p-3"
